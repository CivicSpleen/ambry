...
class US:
    ...
    def usgeo(self):
        try:
            ...
            raise ConfigurationError(
                "MISSING DEPENDENCY: " + "To use the US geo datasets, the bundle ( or library  ) must specify a" +
    ...
    def _places(self):
        try:
            ...
            raise ConfigurationError(
                "MISSING DEPENDENCY: " + "To use the US county datasets, the bundle ( or library  ) must specify a" +
    ...
    @property
    def places(self):
        for row in self._places().query(
                """SELECT AsText(geometry) as wkt, SRID(geometry) as srid, *  FROM places"""):
