...
class Test(TestBase):
    ...
    def test_expand_to_years(self):
        ...
        self.assertEqual([2007], expand_to_years('2007'))
        self.assertEqual([2007], expand_to_years(2007))

        self.assertEqual([2007, 2008, 2009, 2010, 2011],
        ...
        self.assertEqual('1990/2013', compress_years(mixed))

        self.assertEqual('1990/2013', compress_years(
