...
class Test(TestBase):
    def setUp(self):
        ...
        import test.old.bundles.testbundle.bundle

        self.bundle_dir = os.path.dirname(test.old.bundles.testbundle.bundle.__file__)
    ...
    def test_simple_install(self):
        ...
        from ambry.orm import Partition, Table, Column, ColumnStat, Code, Config, File
    ...
    def test_library_install(self):
        ...
        from ambry.orm import Partition, Column, ColumnStat, Code
